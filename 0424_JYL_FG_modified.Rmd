...
```{r echo=FALSE, fig.height=4}
cox_fit_5<-coxph(Surv(AGEYRS, AGEDIE, cancer_death)~BOOZE_q+SEX+ as.factor(RACE) + GRADES + as.factor(MARRY) + as.factor(SIZE) + AVGSMK + as.factor(SMSA) + URBAN, data=data)
summary(cox_fit_5)
