...
## ~ BOOZE_q + RACE + GRADES + MARRY + SIZE + AVGSMK + SMSA + URBAN, stratify by SEX 
```{r echo=FALSE, fig.height=4}
cox_fit_7<-coxph(Surv(AGEYRS, AGEDIE, cancer_death)~BOOZE_q + strata(SEX) + RACE + GRADES + MARRY + SIZE + AVGSMK + SMSA + URBAN, data=data)
summary(cox_fit_7)
...
## ~ BOOZE, stratify by SEX 
```{r echo=FALSE, fig.height=4}
cox_fit_c4<-coxph(Surv(AGEYRS, AGEDIE, cancer_death)~BOOZE+strata(SEX), data=data)
summary(cox_fit_c4)
...
## ~ BOOZE + RACE + GRADES + MARRY + SIZE + AVGSMK + SMSA + URBAN, stratify by SEX 
```{r echo=FALSE, fig.height=4}
cox_fit_c7<-coxph(Surv(AGEYRS, AGEDIE, cancer_death)~BOOZE + strata(SEX) + RACE + GRADES + MARRY + SIZE + AVGSMK + SMSA + URBAN, data=data)
summary(cox_fit_c7)
